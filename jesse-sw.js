 ...
 *
 * SCOPE MATTERS HERE. The page registers this with { scope: '/jesse' }, not the
 * '/' it would default to. A registration is keyed by scope, and its push
 * subscription belongs to the registration -- so when this and /nicole-sw.js
 ...
 *
 * Everything here is mirrored in nicole-sw.js by hand. The two files share no
